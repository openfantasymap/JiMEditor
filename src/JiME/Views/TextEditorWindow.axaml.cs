	...
	public partial class TextEditorWindow : Window
	{
		...
		public TextEditorWindow( Scenario s, EditMode mode, TextBookData textBookData )
		{
			...
			if ( mode == EditMode.Resolution )
			{
				...
				triggerGroup.IsVisible = true;
			}
			else
			{
				descriptionBlock.IsVisible = false;
				triggerGroup.IsVisible = false;
		...
		private async void OkButton_Click( object sender, RoutedEventArgs e )
		{
			...
			{
				await MessageBox.Show( this, "The Trigger cannot be \"None\".", "Invalid Trigger", MessageBoxButton.OK, MessageBoxImage.Error );
				return;
			}
			...
			successChecked = successCB.IsChecked == true;
